...
FLAGS="-qsmp=omp -O3  -qinline -DDOWORK -DDOWORK_IN_CS -DDOWORK_OUTSIDE_CS -DMAX_DATA=2 -DPROFILE"
CXX=xlc++
...
do
#$CXX $FLAGS -DTHE_WAIT="$i" -o hmcs_ppc_new_adapt hmcs_new_adapt.cpp -lrt 
$CXX $FLAGS -DTHE_WAIT="$i" -o hmcs_ppc_new_adapt hmcs_new_adapt_take2.cpp -lrt 
time ./hmcs_ppc_new_adapt $mustBeAMultiple $timeout $nIter 128 3 4 $level1TH 32  $level2TH 128 $level3TH
done
