...
atomic{  
  if
  :: setup == false -> setup = true; assert (abortedLevel_Acq_L2 == 1); ch2!true;
  :: else -> skip;
  fi
};
...
/** Inform mid ***/
    ch1!true; 
            ...
            :: d_step{predStat_Acq_L2_WL2M == CANT_WAIT_FOR_NEXT ->
                        ...
                        d_step {MY_L2_STATUS = UNLOCKED; acquired = true;};
            :: atomic { else -> 
                      if 
                      :: MY_L2_STATUS == UNLOCKED ->  acquired = true;
...
// Always succeeds in acquisition
ReleaseL2();
