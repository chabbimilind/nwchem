...
#define MAX_STATS (10)
    ...
    inline void Acquire(QNode *I){
        ...
        switch(depthToEnqueue){
            case 1: HMCSLock<1>::Acquire(nodeToEnqueue, I); break;
            case 2: HMCSLock<2>::Acquire(nodeToEnqueue, I); break;
            case 3: HMCSLock<3>::Acquire(nodeToEnqueue, I); break;
            case 4: HMCSLock<4>::Acquire(nodeToEnqueue, I); break;
            case 5: HMCSLock<5>::Acquire(nodeToEnqueue, I); break;
    ...
    inline void Release(QNode *I){
        ...
        if(childNode && (depthlFirstPassed > curDepth)){
            curDepth++;
            curNode = childNode;
        ...
        if ((curDepth != 1) && (depthlFirstPassed < curDepth)){
            curDepth--;
            childNode = curNode;
