...
$CXX -DHOW_LONG_MS=$j -DMAX_DATA=$i -DNITER=4 $FLAGS -DTHE_WAIT="0" -o hmcs_ppc_latency_slow_fast hmcs_ppc_latency_slow_fast.cpp -lrt  &
$CXX -DHOW_LONG_MS=$j -DMAX_DATA=$i -DNITER=4 $FLAGS -DTHE_WAIT="0" -o hmcs_adapt_eager_no_fastpath hmcs_adapt_eager_no_fastpath.cpp -lrt  &
$CXX -DHOW_LONG_MS=$j -DMAX_DATA=$i -DNITER=4 $FLAGS -DTHE_WAIT="0" -o hmcs_adapt_lazy_no_fastpath hmcs_adapt_lazy_no_fastpath.cpp -lrt  &
$CXX -DHOW_LONG_MS=$j -DMAX_DATA=$i -DNITER=4 $FLAGS -DTHE_WAIT="0" -o hmcs_adapt_counter_based_check_cur_first hmcs_adapt_counter_based_check_cur_first.cpp -lrt  &
